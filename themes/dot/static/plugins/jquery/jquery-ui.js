!(function (e, t) {
  ...
  (function (e, t) {
    ...
    (e.cleanData = function (t) {
      ...
      (e.widget = function (t, i, s) {
        ...
        (t = t.split(".")[1]),
          ...
          (a.prototype = e.widget.extend(
            ...
            r,
            { constructor: a, namespace: l, widgetName: t, widgetFullName: n }
          )),
          o
      ...
      (e.widget.extend = function (i) {
        for (
          var n, o, a = s.call(arguments, 1), u = 0, r = a.length;
          u < r;
          u++
        )
          for (n in a[u])
            (o = a[u][n]),
              a[u].hasOwnProperty(n) &&
                o !== t &&
                (e.isPlainObject(o)
      ...
      (e.widget.bridge = function (i, n) {
        ...
        e.fn[i] = function (a) {
          ...
          return (
            (a =
              !u && r.length ? e.widget.extend.apply(null, [a].concat(r)) : a),
            u
              ? this.each(function () {
                  var s,
                    n = e.data(this, o);
        ...
        option: function (i, s) {
          ...
          if ("string" == typeof i)
            if (((u = {}), (i = (n = i.split(".")).shift()), n.length)) {
              for (
                o = u[i] = e.widget.extend({}, this.options[i]), a = 0;
                a < n.length - 1;
                a++
              )
                (o[n[a]] = o[n[a]] || {}), (o = o[n[a]]);
        ...
        _on: function (t, i, s) {
          ...
          "boolean" != typeof t && ((s = i), (i = t), (t = !1)),
            ...
            e.each(s, function (s, a) {
              ...
              "string" != typeof a &&
                (u.guid = a.guid = a.guid || u.guid || e.guid++);
              var r = s.match(/^(\w+)\s*(.*)$/),
  ...
  (function (e, t) {
    ...
    function d(e, t, i) {
      return [
        parseFloat(e[0]) * (h.test(e[0]) ? t / 100 : 1),
        parseFloat(e[1]) * (h.test(e[1]) ? i / 100 : 1),
      ];
    }
    function m(t, i) {
    ...
    (e.position = {
      scrollbarWidth: function () {
        ...
        return (
          ...
          t === (s = o.offsetWidth) && (s = n[0].clientWidth),
          n.remove(),
          (i = t - s)
        );
      },
        ...
        return (
          ...
          e.each(["my", "at"], function () {
            ...
            1 === s.length &&
              ...
              (e = r.exec(s[0])),
              (i = r.exec(s[1])),
              (D[this] = [e ? e[0] : 0, i ? i[0] : 0]),
              (t[this] = [l.exec(s[0])[0], l.exec(s[1])[0]]);
          }),
          1 === C.length && (C[1] = C[0]),
          "right" === t.at[0]
            ? (v.left += h)
            : "center" === t.at[0] && (v.left += h / 2),
          "bottom" === t.at[1]
            ? (v.top += p)
            : "center" === t.at[1] && (v.top += p / 2),
          (i = d(D.at, h, p)),
          (v.left += i[0]),
          (v.top += i[1]),
          this.each(function () {
            ...
            "right" === t.my[0]
              ? (M.left -= l)
              : "center" === t.my[0] && (M.left -= l / 2),
              "bottom" === t.my[1]
                ? (M.top -= c)
                : "center" === t.my[1] && (M.top -= c / 2),
              (M.left += N[0]),
              (M.top += N[1]),
              e.support.offsetFractions ||
                ((M.left = o(M.left)), (M.top = o(M.top))),
              (a = { marginLeft: g, marginTop: _ }),
              e.each(["left", "top"], function (s, n) {
                e.ui.position[C[s]] &&
                  e.ui.position[C[s]][n](M, {
                    targetWidth: h,
                    targetHeight: p,
                    elemWidth: l,
                    elemHeight: c,
              ...
              t.using &&
                (u = function (e) {
                  ...
                  h < l && n(i + o) < h && (d.horizontal = "center"),
                    p < c && n(a + u) < p && (d.vertical = "middle"),
                    s(n(i), n(o)) > s(n(a), n(u))
                      ? (d.important = "horizontal")
                      : (d.important = "vertical"),
                    t.using.call(this, e, d);
                }),
              r.offset(e.extend(M, { using: u }));
          })
        );
      }),
      (e.ui.position = {
      ...
      _scrollIntoView: function (t) {
        ...
        this._hasScroll() &&
          ...
          n < 0
            ...
            : n + u > a && this.activeMenu.scrollTop(o + n - a + u));
      },
      blur: function (e, t) {
