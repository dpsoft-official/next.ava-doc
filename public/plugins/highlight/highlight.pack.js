...
!(function (e) {
  ...
  function f(e, t, a, i) {
    ...
    function m(e, n) {
      ...
      if (t)
        return (
          t.skip ? (M += n) : (t.eB && (M += n), b(), t.rB || t.eB || (M = n)),
          v(t, n),
          t.rB ? 0 : n.length
        );
      var r = u(k, n);
      if (r) {
        ...
        do k.cN && (L += "</span>"), k.skip || (B += k.r), (k = k.parent);
        while (k != r.parent);
        return r.starts && v(r.starts, ""), a.rE ? 0 : n.length;
      }
      if (c(n, k))
        throw new Error(
          'Illegal lexeme "' + n + '" for mode "' + (k.cN || "<unnamed>") + '"'
        );
...
hljs.registerLanguage("javascript", function (e) {
  return {
    ...
    k: {
      keyword:
        "in of if for while finally var consultant function do return void else break catch instanceof with throw case default try this switch continue typeof delete let yield const export super debugger as async await static import from as",
...
hljs.registerLanguage("typescript", function (e) {
  var r = {
    keyword:
      "in if for while finally var consultant function do return void else break catch instanceof with throw case default try this switch continue typeof delete let yield const class public private protected get set super static implements enum export import declare type namespace abstract",
    literal: "true false null undefined NaN Infinity",
    built_in:
...
hljs.registerLanguage("php", function (e) {
  ...
  return {
    ...
    cI: !0,
    k: "and include_once list abstract global private echo interface as static endswitch array null if endwhile or const for endforeach self var while isset public protected exit foreach throw elseif include __FILE__ empty require_once do xor return parent clone use __CLASS__ __LINE__ else break print eval consultant catch __METHOD__ case exception default die require __FUNCTION__ enddeclare final try switch continue endfor endif declare unset true false trait goto instanceof insteadof __DIR__ __NAMESPACE__ yield finally",
    c: [
      e.HCM,
      e.C("//", "$", { c: [a] }),
...
hljs.registerLanguage("coffeescript", function (e) {
  var c = {
      keyword:
        "in if for while finally consultant do return else break catch instanceof throw try this switch continue typeof delete debugger super then unless until loop of by when and or is isnt not",
...
hljs.registerLanguage("java", function (e) {
  ...
  return {
    ...
    c: [
      ...
      { bK: "consultant throw return else", r: 0 },
      {
        cN: "function",
        b: "(" + a + "\\s+)+" + e.UIR + "\\s*\\(",
        rB: !0,
...
hljs.registerLanguage("scala", function (e) {
  ...
  return {
    k: {
      ...
      keyword:
        "type yield lazy override def with val var sealed abstract private trait object if forSome for while throw finally protected extends import final return else break consultant catch super class case package default try this match continue throws implicit",
    },
...
hljs.registerLanguage("go", function (e) {
  var t = {
    ...
    built_in:
      "append cap close complex copy imag len make consultant panic print println real recover delete",
  };
  return {
    aliases: ["golang"],
    k: t,
...
hljs.registerLanguage("groovy", function (e) {
  return {
    k: {
      literal: "true false null",
      keyword:
        "byte short char int long boolean float double void def as in assert trait super this abstract static volatile transient public private protected synchronized final class interface enum if else for while switch case break default continue throw throws try catch finally implements extends consultant import package return instanceof",
    },
    c: [
      e.C("/\\*\\*", "\\*/", {
        r: 0,
...
hljs.registerLanguage("cs", function (e) {
  ...
  return {
    ...
    c: [
      ...
      { bK: "consultant return throw await", r: 0 },
      {
        cN: "function",
        b: "(" + r + "\\s+)+" + e.IR + "\\s*\\(",
        rB: !0,
...
hljs.registerLanguage("ruby", function (e) {
  var b =
    ...
    i = { cN: "params", b: "\\(", e: "\\)", endsParent: !0, k: c },
    d = [
      t,
      a,
      {
