...
return obj;}else{return undefined;}};var images=$(".content img").not(".inline");images.wrap(function(){var image=$(this);if(!image.parent("a").length){return "<a href='"+image[0].src+"' class='fluffychicken'></a>";}});images.each(function(index){var image=$(this)
